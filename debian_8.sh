...
sudo apt-get install expect -y && apt-get -y update && sudo apt-get -y upgrade
...
clear
echo "Softether installation and configuration has been done!"
echo " "
echo "Host: ${HOST}"
echo "Virtual Hub: ${HUB}"
echo "Port: 443, 53, 137, 500, 921, 4500, 4000, 40000"
echo "Username: ${USER}"
